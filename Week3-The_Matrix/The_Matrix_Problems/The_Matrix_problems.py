...
M_swap_two_vector = [[0,1], [0, 1]]



## 3: (Problem 4.17.3) [z+x, y, x] Matrix-vector multiplication
three_by_three_matrix = [[0, 0, 1], [0, 1, 0], [1, 0,   1]] # Represent with a list of rowlists.
...
# Example: [[1,1],[2,2]]
small_mat_mult_1 = [[8, 10], [8, 14]]
small_mat_mult_2 = [[22, 9, 4], [1, 3, 0]]
small_mat_mult_3 = [[4, 13]]
small_mat_mult_4 = [[14]]
small_mat_mult_5 = [[1, 2, 3], [2, 4, 6], [3, 6, 9]]
small_mat_mult_6 = [[-1, 1], [1, 0]]
...
your_answer_a_AB = [[0, 0, 1, 0], [0, 0, 2, 0], [0, 0, -4, 0], [0, 0, 2, 0]]
your_answer_a_BA = [[0, 0, 0, 0], [1, -2, 4, 2], [0, 0, 0, 0], [0, 0, 0, 0]]

your_answer_b_AB = [[0, 2, 0, 1], [0, 5, 0, -2], [0, 4, 0, 4], [0, 6, 0, 2]]
your_answer_b_BA = [[0, 0, 0, 0], [2, 5, 4, 6], [0, 0, 0, 0], [1, -2, 4, 2]]

your_answer_c_AB = [[6, 0, 0, 0], [6, 0, 0, 0], [8, 0, 0, 0], [5, 0, 0, 0]]
your_answer_c_BA = [[4, 1, 4, -1], [4, 1, 4, -1], [0, 0, 0, 0], [0, 0, 0, 0]]

your_answer_d_AB = [[0, 3, 0, 4], [0, 4, 0, -1], [0, 4, 0, 4], [0, -6, 0, -1]]
your_answer_d_BA = [[0, 11, 0, -2], [0, 0, 0, 0], [0, 0, 0, 0], [2, 5, 4, 6]]

your_answer_e_AB = [[0, 3, 0, 8], [0, -9, 0, 2], [0, 0, 0, 8], [0, 15, 0, -2]]
your_answer_e_BA = [[-2, 12, 2, -10], [0, 0, 0, 0], [0, 0, 0, 0], [-3, -15, 6, -9]]

your_answer_f_AB = [[-4, -1, -4, 1], [8, 10, 8, 12], [2, -4, 8, 4], [3, 9, 0, -15]]
...
column_row_vector_multiplication2 = Vec({0, 1, 2}, {0: 20, 1: 11, 2: 1})

column_row_vector_multiplication3 = Vec({0, 1, 2, 3}, {0: 2, 1: 8, 2: 11, 3: 3})

column_row_vector_multiplication4 = Vec({0,1}, {0: 30, 1: 16})

column_row_vector_multiplication5 = Vec({0, 1, 2}, {0: 0, 1:10, 2: -2})
